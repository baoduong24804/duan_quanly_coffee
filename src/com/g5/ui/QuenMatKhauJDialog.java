...
//        });
    ...
    void layLaiTK() {
        ...
        for (NhanVien nhanVien : nvList) {
            ...
            if (tk.equalsIgnoreCase((String.valueOf("NV" + nhanVien.getMaNV())))) {

                if (gmail.equalsIgnoreCase(nhanVien.getEmail().trim())) {

                    send();
                    TextMes.Alert(null, "Đã gửi mã xác nhận bạn vui lòng kiểm tra gmail");
        ...
        TextMes.Alert(null, "Tài khoản hoặc gmail không có trên hệ thống");
        //   send();
    }
    int OTP;
