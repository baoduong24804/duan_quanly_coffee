...
public class XacNhanMatKhauJDiaLog extends javax.swing.JDialog {
    ...
    public XacNhanMatKhauJDiaLog(java.awt.Frame parent, boolean modal) {
        ...
        txtTaiKhoan.setText("NV"+(QuenMatKhauJDialog.getMaNV() + "").trim());
    ...
    public void DoiMatKhau() {
        ...
        if (!mkmoi.equals(XNmk)) {
            ...
            for (NhanVien nhanVien : list) {
                if (String.valueOf("NV"+QuenMatKhauJDialog.getMaNV()).equalsIgnoreCase((String.valueOf("NV"+nhanVien.getMaNV())).trim())) {
                    nvdao.forgotpass(mkmoi, QuenMatKhauJDialog.getMaNV());
        ...
        TextMes.Alert(this, "Đổi mật khẩu thất bại vui lòng thử lại");
    }
}
