...
public class SanPhamJPanel extends javax.swing.JPanel {
    ...
    final int h = 248;
    int count;
public static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(SanPhamJPanel.class);
    /**
    ...
    public SanPhamJPanel() {
        ...
        tblChiTiet.getTableHeader().setBackground(new Color(32, 136, 203));
    ...
    void setFormCT(GiaSP gsp) {
        ...
        for (String string : list) {
            cboSize.addItem(string.toString().trim());
        }
        if (list.size() > 0) {
            if (index != -1) {
            ...
            String formattedValue = String.format("%.0f", dao.getGiaByMaSPAndSize(Integer.parseInt(txtMaSP1.getText().trim()), cboSize.getSelectedItem().toString().trim()));
...
//        btnLast.setEnabled(edit && !last);
    ...
    GiaSP getFormCT() {
        ...
        sp.setSize(cboSize.getSelectedItem().toString().trim());
    ...
    GiaSP FirstPrice() {
        ...
        fp.setSize(cboGiaSizeDau.getSelectedItem().toString().trim());
    ...
    void insertSP() {
        ...
        dao.create(sp);
                logger.info("Người dùng [Mã nhân viên: " + Auth.user.getMaNV() + " | Họ tên: " + Auth.user.getHoTen() + "]" + " vừa thêm sản phẩm :" + sp.getMaSP() + " "+sp.getTenSP());
        fillTableDSSP();
    ...
    void insertCT() {
        ...
        if (containsOne) {
            ...
            daoCT.create(sp);
                    logger.info("Người dùng [Mã nhân viên: " + Auth.user.getMaNV() + " | Họ tên: " + Auth.user.getHoTen() + "]" + " vừa thêm giá sản phẩm :" + sp.getMaSP());
    ...
    void kiemLoiSP() {
        ...
        String giaNL = txtGiaNL.getText();
        String soLuong = txtSoLuong.getText();

        if (txtTenSP.getText().isEmpty()) {
            TextMes.Alert(this, "Chưa nhập tên SP");
            return;
        } else if (txtGiaNL.getText().isEmpty()) {
            TextMes.Alert(this, "Chưa nhập giá nhập");
            return;
//        } else if (txtMoTa.getText().isEmpty()) {
//            TextMes.Alert(this, "Chưa nhập mô tả");
//            return;
//        } else if (txtGia.getText().isEmpty()) {
//            TextMes.Alert(this, "Chưa nhập giá sản phẩm");
//            return;
        } else if (txtSoLuong.getText().isEmpty()) {
            TextMes.Alert(this, "Chưa nhập số lượng");
            return;
        }
//        try {
//            Integer value = Integer.parseInt(gia);
//            if (value instanceof Integer) {
//                System.out.println("");
//            }
//        } catch (Exception e) {
//            TextMes.Alert(this, "Giá sai định dạng");
//            return;
//        }

        try {
            Integer value = Integer.parseInt(giaNL);
            if (value instanceof Integer) {
                System.out.println("");
            }
        } catch (Exception e) {
        ...
        try {
            Integer gia1 = Integer.parseInt(soLuong);
            if (gia1 instanceof Integer) {
                System.out.println("");
            }
        } catch (Exception e) {
            TextMes.Alert(this, "Số lượng sai định dạng");
            return;
        }
    }
    ...
    void kiemLoiCT() {
        ...
        String gia = txtGia1.getText();
        if (txtMaSP1.getText().isEmpty()) {
            TextMes.Alert(this, "Chưa nhập tên SP");
            return;
        } else if (txtGia1.getText().isEmpty()) {
            TextMes.Alert(this, "Chưa nhập giá sản phẩm");
            return;
        } else if (cboSize.getSelectedItem() == "") {
            TextMes.Alert(this, "Chưa chọn Size");
            return;
        }
    ...
    void deleteSP() {
        try {
            ...
            dao.deteleByID(masp);
                    logger.info("Người dùng [Mã nhân viên: " + Auth.user.getMaNV() + " | Họ tên: " + Auth.user.getHoTen() + "]" + " vừa xóa sản phẩm :" + masp);
    ...
    void deleteCT() {
        ...
        try {
            ...
            int masp = Integer.parseInt(txtMaSP1.getText().trim());
            daoCT.deteleByID(Integer.parseInt(txtMaSP1.getText().trim()), String.valueOf(cboSize.getSelectedItem().toString().trim()));
                    logger.info("Người dùng [Mã nhân viên: " + Auth.user.getMaNV() + " | Họ tên: " + Auth.user.getHoTen() + "]" + " vừa xóa size sản phẩm :" + masp);
    ...
    void updateSP() {
        ...
        dao.update(sp);
                logger.info("Người dùng [Mã nhân viên: " + Auth.user.getMaNV() + " | Họ tên: " + Auth.user.getHoTen() + "]" + " vừa cập nhật sản phẩm :" + sp.getMaSP() + " "+sp.getTenSP());
    ...
    void updateCT() {
        ...
        daoCT.update(sp);
                logger.info("Người dùng [Mã nhân viên: " + Auth.user.getMaNV() + " | Họ tên: " + Auth.user.getHoTen() + "]" + " vừa cập nhật size sản phẩm : " + sp.getMaSP());
        //    fillTableSPCT();
    ...
    private void initComponents() {
        ...
        lblGiaNL1 = new javax.swing.JLabel();
        cboGiaSizeDau = new javax.swing.JComboBox<>();
        btnthemSizedau = new javax.swing.JButton();
        ...
        lblGiaNL1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblGiaNL1.setText("Size");

        cboGiaSizeDau.setEnabled(false);
        cboGiaSizeDau.setPreferredSize(new java.awt.Dimension(53, 30));

        btnthemSizedau.setText("+");
        btnthemSizedau.setEnabled(false);
        btnthemSizedau.setPreferredSize(new java.awt.Dimension(33, 21));
        btnthemSizedau.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnthemSizedauActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                        .addComponent(cboGiaSizeDau, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(btnthemSizedau, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(lblGiaNL1)
                                    .addComponent(cboGiaSizeDau, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(btnthemSizedau, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void btnMoiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMoiActionPerformed
        ...
        btnXoa.setEnabled(false);
        btnSua.setEnabled(false);
        cboGiaSizeDau.setEnabled(true);
        btnthemSizedau.setEnabled(true);
        DefaultComboBoxModel model = (DefaultComboBoxModel) cboGiaSizeDau.getModel();
        model.removeAllElements();
        model.setSelectedItem("Size M");
        removeCbo(cboGiaSizeDau);
    ...
    private void btnthemSizedauActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnthemSizedauActionPerformed
        // TODO add your handling code here:
        String loaisp = "";
        loaisp = JOptionPane.showInputDialog("Thêm size").trim();
        if (loaisp.trim().isEmpty()) {
            return;
        }
        DefaultComboBoxModel model = (DefaultComboBoxModel) cboGiaSizeDau.getModel();
        model.addElement(loaisp.trim());
        removeCbo(cboGiaSizeDau);
    }//GEN-LAST:event_btnthemSizedauActionPerformed
    ...
    private javax.swing.JButton btnthemSizedau;
    private javax.swing.ButtonGroup buttonGroup1;
    private javax.swing.ButtonGroup buttonGroup2;
    private javax.swing.JComboBox<String> cboGiaSizeDau;
    ...
    private javax.swing.JLabel lblGiaNL1;
