...
//    int MaSP;
    ...
    public static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(HoaDonJPanel.class);
...
//    }
    ...
    private void initComponents() {
        ...
        btnThemSua.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(btnThemSua, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
        ...
        tblHoaDonChiTiet.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã SP", "Tên sản phẩm", "Số lượng", "Giá", "Size"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Object.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Float.class, java.lang.String.class
            };
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false, false
            };
        ...
        if (tblHoaDonChiTiet.getColumnModel().getColumnCount() > 0) {
            ...
            tblHoaDonChiTiet.getColumnModel().getColumn(1).setPreferredWidth(50);
            tblHoaDonChiTiet.getColumnModel().getColumn(2).setPreferredWidth(200);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            //     TextMes.Alert(null, "Xuất Exel thành công");
        } catch (Exception e) {
    ...
    private void btnThemSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemSuaActionPerformed
        ...
        MuaSanPhamJDialog msp = new MuaSanPhamJDialog(null, true, Integer.parseInt(txtMaHD.getText()));
        msp.setVisible(true);
        new Thread(new Runnable() {
            ...
            public void run() {
                for (int i = 0;;) {
                    ...
                    if (!msp.isVisible()) {
                        FillTableHoaDonChiTet(Integer.parseInt(txtMaHD.getText()));
                        clearHDCT();
                        return;
                    }
    ...
    void insert(HoaDon hd) {
        ...
        logger.info("Người dùng [Mã nhân viên: " + Auth.user.getMaNV() + " | Họ tên: " + Auth.user.getHoTen() + "]" + " vừa thêm hóa đơn :" + hd.getMaHD());
    }

    void deleteHoaDon() {
        hdDao.deteleByID(Integer.parseInt(txtMaHD.getText()));
        TextMes.Alert(null, "Xóa hóa đơn thành công");
        logger.info("Người dùng [Mã nhân viên: " + Auth.user.getMaNV() + " | Họ tên: " + Auth.user.getHoTen() + "]" + " vừa xóa hóa đơn :" + Integer.parseInt(txtMaHD.getText()));
        FillTable();
        clearHoaDon();
    ...
    void clearHoaDon() {
        ...
        lblTongTien.setText(Validate.chuyenGiaVietNam(Float.parseFloat("0")));
    ...
    void setEntityToForm(HoaDon hd) {
        ...
        txtNgayTao.setText(XDate.ChuyenNgay2(hd.getNgayTao()));
        ...
        if (row != -1) {
            ...
            if (hoadon.isTrangthai()) {
                ...
                if (hd != null) {
                    ...
                    lblTongTien.setText(Validate.chuyenGiaVietNam(tongtien));
                } else {
    ...
    void FillTableHoaDonChiTet(int MaHD) {
        SanPhamDao daoct = new SanPhamDao();
        DefaultTableModel model = (DefaultTableModel) tblHoaDonChiTiet.getModel();
        model.setRowCount(0);
        ...
        for (HoaDonChiTiet hd : list) {
            SanPham sp = daoct.getByID(hd.getMaSP());
            Object[] rowData = new Object[]{++a, hd.getMaSP(), sp.getTenSP(), hd.getSoluong(), hd.getGia(), hd.getSize()};
            model.addRow(rowData);
        ...
        if (list.isEmpty()) {
            ...
            lblTongTien.setText(Validate.chuyenGiaVietNam(tongtienThanhToan));
            txt_tienkhachtra.setText("");
            txt_tienthoi.setText("");
        }
        if (!list.isEmpty()) {
    ...
    HoaDon getFormThanhToan() {
        ...
        try {
            ...
            String tien = Validate.chuyenGiaMacDinh(lblTongTien.getText().trim());
            String tien2 = tien;
    ...
    HoaDonChiTiet getFormHDCT() {
        ...
        String giaText = Validate.chuyenGiaMacDinh(txtGia.getText().trim());
        ...
        try {
            ...
            for (SanPham sp : ls) {
                if (hd.getMaSP() == sp.getMaSP()) {
                    ...
                    modelSize.setSelectedItem(tblHoaDonChiTiet.getValueAt(indexHDCT, 5));
                    break;
                }
            }
            ...
            txtKhuyenMai.setText(String.valueOf(sale).replace(".0", ""));
            cboSizeSP.setSelectedItem(hd.getSize());
//            if (hd.getPTkhuyenmai() != -1.0f) {
//                float thanhtien = hd.getGia() * hd.getSoluong() * (1 - hd.getPTkhuyenmai()/100);
//                txtThanhTien.setText(String.valueOf(thanhtien));
//            } else {
//                float thanhtien = hd.getGia() * hd.getSoluong();
//                txtThanhTien.setText(String.valueOf(thanhtien));
//            }
            txtGia.setText(Validate.chuyenGiaVietNam(hd.getGia()));
            txtThanhTien.setText(Validate.chuyenGiaVietNam(hd.getGia() * hd.getSoluong()));
            lblTongTien.setText(Validate.chuyenGiaVietNam(tongtien));
    ...
    HoaDonChiTiet getEntityHD() {
        ...
        HoaDonChiTiet hoadon = hdctdao.getByIDSP(id, mahd);
        return hoadon;
    }
...
//        }
    ...
    void updateGiaBasedOnSoLuong() {
        try {
            ...
            if (soLuongStr.isEmpty() || giaTheoSize <= 0) {
                ...
                txtThanhTien.setText(String.valueOf(thanhtien));
                lblTongTien.setText(Validate.chuyenGiaVietNam(Float.parseFloat("0"))); // Clear lblTongTien
            }
    ...
    void TraTien() {
        ...
        if (!tienKhachTraText.isEmpty()) {
            try {
                ...
                txt_tienthoi.setText(Validate.chuyenGiaVietNam(tienthoi));
            } catch (NumberFormatException e) {
                e.printStackTrace();
            }
        } else {
    ...
    void deleteHDCT() {
        try {
//            SanPhamDao spdao = new SanPhamDao();
//            SanPham sp = spdao.getByID(Integer.parseInt(txt_MASP.getText().trim()));
//            int soluongsp = 0;
//            int soluong = Integer.parseInt(txtSoLuong.getText());
//            soluongsp = soluong + sp.getSoLuong();
//            sp.setSoLuong(soluongsp);
//            sp.setMaSP(Integer.parseInt(txt_MASP.getText().trim()));
//            spdao.upSoluong(sp);

            hdctdao.deteleByID(Integer.parseInt(txt_MASP.getText()), Integer.parseInt(txtMAHD.getText()), cboSizeSP.getSelectedItem().toString().trim());
                    logger.info("Người dùng [Mã nhân viên: " + Auth.user.getMaNV() + " | Họ tên: " + Auth.user.getHoTen() + "]" + " vừa xóa sản phẩm: " + txt_MASP.getText());
            HoaDonChiTiet hd = getFormHDCT();
            FillTableHoaDonChiTet(hd.getMaHD());
            clearHDCT();
        } catch (Exception e) {
    ...
    void updateHD() {
        ...
        logger.info("Người dùng [Mã nhân viên: " + Auth.user.getMaNV() + " | Họ tên: " + Auth.user.getHoTen() + "]" + " vừa cập hóa đơn :" + hd.getMaHD());
        FillTable();
    }
    ...
    void setStatus(boolean insertable) {
        ...
        btnThemSua.setEnabled(insertable);
        btnThemSua.setEnabled(!insertable);
...
//            float[] columnWidthsSP = {50f, 90f, 50f, 60f, 50f};
//            PdfPTable tableSP = new PdfPTable(columnWidthsSP);
//            tableSP.setWidthPercentage(100);
//
//            // Xóa border cho tất cả các ô trong bảng
//            // Thêm các cột cho bảng
//            PdfPCell cell1 = new PdfPCell(new Paragraph("Số lượng", fontSP));
//            cell1.setBorder(Rectangle.NO_BORDER);
//            tableSP.addCell(cell1);
//
//            PdfPCell cell2 = new PdfPCell(new Paragraph("Tên sản phẩm", fontSP));
//            cell2.setBorder(Rectangle.NO_BORDER);
//            tableSP.addCell(cell2);
//
//            PdfPCell cell3 = new PdfPCell(new Paragraph("Đơn giá", fontSP));
//            cell3.setBorder(Rectangle.NO_BORDER);
//            tableSP.addCell(cell3);
//
//            PdfPCell cell4 = new PdfPCell(new Paragraph("Khuyến mãi", fontSP));
//            cell4.setBorder(Rectangle.NO_BORDER);
//            tableSP.addCell(cell4);
//
//            PdfPCell cell5 = new PdfPCell(new Paragraph("Thành tiền", fontSP));
//            cell5.setBorder(Rectangle.NO_BORDER);
//            tableSP.addCell(cell5);
//
...
//
//                // Thêm dòng cho bảng và xóa border
//                PdfPCell cell6 = new PdfPCell(new Paragraph(hoaDonChiTiet.getSoluong() + "", fontSP));
//                cell6.setBorder(Rectangle.NO_BORDER);
//                tableSP.addCell(cell6);
//
//                PdfPCell cell7 = new PdfPCell(new Paragraph(listSP.getTenSP(), fontSP));
//                cell7.setBorder(Rectangle.NO_BORDER);
//                tableSP.addCell(cell7);
//                KhuyenMaiDAO kmdao = new KhuyenMaiDAO();
//                try {
//                    int timThay = kmdao.getSPINKM(hoaDonChiTiet.getMaHD());
//                    PdfPCell cell8;
//                    float giaKhuyenMai = 0;
//                    float giaTong = 0;
//                    if (timThay == 0) {
//                        // Không có khuyến mãi, sử dụng giá gốc
//                        cell8 = new PdfPCell(new Paragraph(Validate.chuyenGiaVietNam(hoaDonChiTiet.getGia()) + "", fontSP));
//                        cell8.setBorder(Rectangle.NO_BORDER);
//                        tableSP.addCell(cell8);
//
//                        PdfPCell cell9 = new PdfPCell(new Paragraph("Không có", fontSP));  // Thêm thông tin cần hiển thị thay vì "Không có"
//                        cell9.setBorder(Rectangle.NO_BORDER);
//                        tableSP.addCell(cell9);
//
//                        PdfPCell cell10 = new PdfPCell(new Paragraph(Validate.chuyenGiaVietNam((hoaDonChiTiet.getGia() * hoaDonChiTiet.getSoluong())) + "", fontSP));
//                        cell10.setBorder(Rectangle.NO_BORDER);
//                        tableSP.addCell(cell10);
//                    } else {
//                        // Có khuyến mãi, sử dụng giá sau khi áp dụng khuyến mãi
//                        float sale = kmdao.getKhuyenMai(hoaDonChiTiet.getMaSP());
//                        giaKhuyenMai = hoaDonChiTiet.getGia();
//                        if (sale != -1.0f) {
//                            giaKhuyenMai = giaKhuyenMai * (1 - sale);
...
//                        cell8 = new PdfPCell(new Paragraph(chunk + "", fontSP));
//                        cell8.setBorder(Rectangle.NO_BORDER);
//                        tableSP.addCell(cell8);
//
//                        PdfPCell cell9 = new PdfPCell(new Paragraph(Validate.chuyenGiaVietNam(giaKhuyenMai) + "", fontSP));  // Thêm thông tin cần hiển thị thay vì "Không có"
//                        cell9.setBorder(Rectangle.NO_BORDER);
//                        tableSP.addCell(cell9);
//
//                        PdfPCell cell10 = new PdfPCell(new Paragraph(Validate.chuyenGiaVietNam(giaTong) + "", fontSP));
//                        cell10.setBorder(Rectangle.NO_BORDER);
//                        tableSP.addCell(cell10);
//
//                    }
//                } catch (Exception e) {
//                    e.printStackTrace();  // Xử lý exception một cách chí tiết hơn
//                }
//            }
//            paragraphSP.add(tableSP);
...
//            float[] columnThanhToan = {200f, 50f, 50f};
//            PdfPTable tableTT = new PdfPTable(columnThanhToan);
//            tableTT.getDefaultCell().setBorder(Rectangle.NO_BORDER);
//            tableTT.setWidthPercentage(100);
//
//            float tienthoilai = hdTT.getTienKhachTra() - hdTT.getTongTien();
//            tableTT.addCell(new Paragraph("Tiền khách trả:", fontTra));
//            tableTT.addCell(new Paragraph("", fontTra));
//            tableTT.addCell(new Paragraph(hdTT.getTienKhachTra() + "", fontTra));
//            tableTT.addCell(new Paragraph("Tiền thối:", fontTra));
//            tableTT.addCell(new Paragraph("", fontTra));
//            tableTT.addCell(new Paragraph(tienthoilai + "", fontTra));
//
//            paragraphTra.add(tableTT);
//            paragraphTra.setAlignment(Paragraph.ALIGN_LEFT);
    ...
    void InHoaDon() {
        ...
        try {
            ...
            for (HoaDonChiTiet hoaDonChiTiet : listCT) {
                ...
                KhuyenMaiDAO kmdao = new KhuyenMaiDAO();
                try {
                    int timThay = kmdao.getSPINKM(hoaDonChiTiet.getMaSP());
                    ...
                    if (timThay == 0) {
                        ...
                        giaKhuyenMai = hoaDonChiTiet.getGia();
                        if (sale != -1.0f) {
                            giaKhuyenMai = giaKhuyenMai * (1 - sale / 100);
                            giaTong = giaKhuyenMai * hoaDonChiTiet.getSoluong();
                        }
                        Phrase phrase = new Phrase();
                        Chunk chunk = new Chunk(Validate.chuyenGiaVietNam(hoaDonChiTiet.getGia()) + " ", fontSP);
                        chunk.setUnderline(0.5f, 5f);
//                        Paragraph pr = new Paragraph(chunk + "", fontSP);
//                        document.add(pr);
                        phrase.add(chunk);
            ...
            document.add(paragraphgach);
            // Tổng tiền
            Paragraph paragraphTong = new Paragraph("", fontSP);
            float[] columnTong = {250f, 50f};
            PdfPTable tableTong = new PdfPTable(columnTong);
            tableTong.getDefaultCell().setBorder(Rectangle.NO_BORDER);
            tableTong.setWidthPercentage(100);
            tableTong.addCell(new Paragraph("Tổng tiền: ", fontSP));
            tableTong.addCell(new Paragraph(Validate.chuyenGiaVietNam(tongtien) + "", fontSP));
            paragraphTong.add(tableTong);
            ...
            tableTT.addCell(new Paragraph("Tiền khách trả:", fontTra));
            tableTT.addCell(new Paragraph("", fontTra));
            tableTT.addCell(new Paragraph(Validate.chuyenGiaVietNam(hdTT.getTienKhachTra()) + "", fontTra));
            tableTT.addCell(new Paragraph("Tiền thối:", fontTra));
            tableTT.addCell(new Paragraph("", fontTra));
            tableTT.addCell(new Paragraph(Validate.chuyenGiaVietNam(tienthoilai) + "", fontTra));
