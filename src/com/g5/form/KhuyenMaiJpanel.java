...
public class KhuyenMaiJpanel extends javax.swing.JPanel {
    ...
    int choose;
public static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(KhuyenMaiJpanel.class);
    /**
    ...
    public KhuyenMaiJpanel() {
        ...
        tblKM.getTableHeader().setFont(new Font("Tohoma", 1, 16));
 ...
 PropertyConfigurator.configure("src/com/g5/log/log4j.properties");
    ...
    private void initComponents() {
        ...
        txtBatdau.setPreferredSize(new java.awt.Dimension(74, 30));
        ...
        txtKetthuc.setPreferredSize(new java.awt.Dimension(74, 30));
        ...
        tblSP.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã SP", "Tên SP", "Giá đã giảm", "Đã giảm"
            }
        ) {
        ...
        tblSP.setSelectionBackground(new java.awt.Color(102, 255, 102));
        ...
        tblKM.setIntercellSpacing(new java.awt.Dimension(0, 0));
        tblKM.setOpaque(false);
        tblKM.setRowHeight(50);
        tblKM.setSelectionBackground(new java.awt.Color(102, 255, 102));
        ...
        if (tblKM.getColumnModel().getColumnCount() > 0) {
            tblKM.getColumnModel().getColumn(0).setPreferredWidth(10);
            tblKM.getColumnModel().getColumn(1).setPreferredWidth(10);
            tblKM.getColumnModel().getColumn(5).setPreferredWidth(10);
        }
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(txtBatdau, javax.swing.GroupLayout.DEFAULT_SIZE, 244, Short.MAX_VALUE)
    ...
    private void btnAdddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdddActionPerformed
        ...
        try {
            ...
            insertKM(km);
                    logger.info("Người dùng [Mã nhân viên: " + Auth.user.getMaNV() + " | Họ tên: " + Auth.user.getHoTen() + "]" + " vừa thêm khuyến mãi :" + km.getMaKM() + " "+km.getTenKM());
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        try {
            ...
            KhuyenMai km = getForm((int) tblKM.getValueAt(choose, 1));
            if(km == null){
            return;
            }
            updateKM(km);
                    logger.info("Người dùng [Mã nhân viên: " + Auth.user.getMaNV() + " | Họ tên: " + Auth.user.getHoTen() + "]" + " vừa cập nhật khuyến mãi :" + km.getMaKM() + " "+km.getTenKM());
    ...
    private void btnDellActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDellActionPerformed
        // TODO add your handling code here:
        try {
            int makm = (Integer) tblKM.getValueAt(choose, 1);
            deleteKM((Integer) tblKM.getValueAt(choose, 1));
                    logger.info("Người dùng [Mã nhân viên: " + Auth.user.getMaNV() + " | Họ tên: " + Auth.user.getHoTen() + "]" + " vừa xóa khuyến mãi :" + makm);
            JOptionPane.showMessageDialog(null, "Xóa thành công mã khuyến mãi số " + tblKM.getValueAt(choose, 0));
            fillTable();
            clearForm();
            btnDell.setEnabled(false);
            btnEdit.setEnabled(false);
    ...
    public Object[][] getSanPhamData(String maKM) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                row[3] = Validate.chuyenGiaVietNam(rs.getFloat("Gia"));
                data.add(row);
            }
    ...
    KhuyenMai getForm() {
        ...
        if(PTkm < 1 || PTkm > 100){
            TextMes.Alert(null, "Phần trăm khuyến mãi không hợp lệ");
            return null;
        }
    ...
    void fillTable() {
        ...
        for (KhuyenMai km : list) {
            i += 1;
            model.addRow(new Object[]{i, km.getMaKM(), km.getTenKM(), km.getTGBatDau(), km.getTGKetThuc(), km.getMaNV(), String.valueOf(km.getPhanTramKM()).replace(".0", "%")});
        }
    }
    ...
    void fillTableSp(int id) {
        ...
        for (SanPhamKM sp : list) {
            i += 1;
            modelSp.addRow(new Object[]{i, sp.getMaSP(), sp.getTenSP(), Validate.chuyenGiaVietNam(sp.getGia() - (sp.getGia() * (sp.getChietkhau() / 100))), Validate.chuyenGiaVietNam(sp.getGia() * ( sp.getChietkhau() / 100))});
        }
    ...
    void fillform() {
        ...
        txtChietkhau.setText(tblKM.getValueAt(choose, 6).toString().replace("%", "") + "");
